  ...
  lvim.builtin.which_key = {
    ...
    mappings = {
      ...
      s = {
        ...
        f = { "<cmd>lua require('telescope.builtin').find_files({additional_args = {\"-t\", \"cpp\"}})<cr>", "Find File" },
        F = { "<cmd>Telescope find_files<cr>", "Find In All Files" },
        g = { "<cmd>lua require('telescope.builtin').find_files({additional_args = {\"-g\", \"*.gui\"}})<cr>", "Find GUI File" },
